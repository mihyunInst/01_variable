...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		int intNumber = 2147483647; // 변수 선인 및 초기화
		// 자료형	 변수명	 = 리터럴	;
		...
		long longNumber = 10000000000L; // 소문자 대문자 상관 l
		...
		// 변수 명명 규칙
		// 1. 대소문자 구분 O, 길이제한 X
		int adgsdgsdgsg4w2gwgwdgwdgwdgwedgewdgdsg;
		int adgsdgsdgsg4w2gwgwdgwdgwdgwedgewdgdsG;
		...
		int $intNumber; // 문제는 없지만 개발자가 직접 사용 안합니다.
